...
EXPORT_COLUMN_TO_FIELD = {
    ...
    "Remarks": "remarks",
    "Bangsa Suami": "bangsa_suami",
    "Warganegara Suami": "warganegara_suami",
    "Alamat Suami": "alamat_suami",
    "Bangsa Isteri": "bangsa_isteri",
    "Warganegara Isteri": "warganegara_isteri",
    "Alamat Isteri": "alamat_isteri",
    "Hari Nikah": "hari_nikah",
    "Masa Nikah": "masa_nikah",
    "Tempat Nikah": "tempat_nikah",
    "Daerah": "tempat_nikah_daerah",
    "Negeri": "tempat_nikah_negeri",
    "Pernikahan Kali": "pernikahan_kali",
    "Isteri Ke": "isteri_ke",
    "Belanja Hantaran": "belanja_hantaran",
    "Pemberian Lain (Jika Ada)": "pemberian_lain",
    "No Kad Pengenalan/Passport Wali": "ic_wali",
    "Umur Wali": "umur_wali",
    "Alamat Wali": "alamat_wali",
    "Kad Pengenalan/Passport Saksi 1": "ic_saksi_1",
    "Kad Pengenalan/Passport Saksi 2": "ic_saksi_2",
...
def record_from_export_dict(data: Mapping[str, Any]) -> ExtractedRecord:
    ...
    for column, field_name in EXPORT_COLUMN_TO_FIELD.items():
        ...
        if field_name in {"review_reason", "missing_fields"}:
            ...
            continue
        if field_name in {"umur_suami", "umur_isteri", "umur_wali", "source_page"}:
...
def _record_to_row(record: ExtractedRecord) -> list[Any]:
    return [
        ...
        record.alamat_suami,
        record.bangsa_isteri,
        record.warganegara_isteri,
        record.alamat_isteri,
        record.hari_nikah,
        record.masa_nikah,
        record.tempat_nikah,
        record.tempat_nikah_daerah,
        record.tempat_nikah_negeri,
        record.pernikahan_kali,
        record.isteri_ke,
        record.belanja_hantaran,
        record.pemberian_lain,
        record.ic_wali,
        record.umur_wali,
        record.alamat_wali,
        record.ic_saksi_1,
